  ...
  if (step === "choose-role") {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          className="border-sky-800/20 hover:border-blue-800/30 cursor-pointer transition-all shadow-[0_0_10px_#2563eb20]"
        ...
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <Button
              className="w-full mt-2 bg-sky-600 hover:bg-indigo-700"
              disabled={loading}
            >
              {loading ? (
                <>
        ...
        <Card
          className="border-emerald-900/20 hover:border-emerald-700/40 cursor-pointer transition-all shadow-[0_0_10px_#0f766e40]"
