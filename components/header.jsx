...
import { Calendar, CreditCard, LogInIcon, LogOut, ShieldCheck, Stethoscope, User } from 'lucide-react';
        ...
        <header className="fixed top-0 w-full border-b bg-background/80 backdrop-blur-md z-10 supports-[backdrop-filter]:bg-background/60">
            <nav className="max-w-screen-xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex item-center space-x-2">
                    {/* Sign in / Sign up or User button */}
                    <SignedIn>
                        {user?.role === "DOCTOR" && (
                            <Link href="/doctor">
                    ...
                    {(!user || user?.role === "PATIENT") && (<Link href="/pricing"> 
                    <Badge
                                variant="outline"
                    ...
                    <SignedOut>
                        ...
                        <SignUpButton appearance={{ baseTheme: dark }}>
                            <Button variant="outline" >
                                <LogOut />
                                Sign Out
                            </Button>
